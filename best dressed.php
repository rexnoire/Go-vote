...
$top_sql = "SELECT id, name, image_url FROM contestants WHERE gender = 'female' ORDER BY votes DESC LIMIT 3";
$top_result = $conn->query($top_sql);
$top_contestants = $top_result->fetch_all(MYSQLI_ASSOC);

$all_sql = "SELECT id, name, image_url FROM contestants WHERE gender = 'female' ORDER BY name ASC";
...
<head>
  ...
  <title>GoVote — Best Dressed 2026</title>
  <link rel="stylesheet" href="best dressed.css">
...
<div class="phone-container">
  <div class="app-content">
    ...
    <div class="main-title">
      Best Dressed <span class="title-accent">2026</span>
    </div>
